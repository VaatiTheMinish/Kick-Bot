...
from core.event_manager import handle_message, load_events_from_db

#-----

#Uncomment the line below for debugging
#AS THIS IS experimental code, logging is enabled
...
async def on_ready():
    ...
    await load_events_from_db(user.chatroom)
...
== Done Loading {loaded_commands} commannds. == 
   Version: -experimental- | Made by Ryohei
